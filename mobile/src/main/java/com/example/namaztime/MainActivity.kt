...
import com.example.namaztime.ui.theme.NamazTimeTheme
...
class MainActivity : ComponentActivity(), LocationListener {
    ...
    private lateinit var prayerTimeManager: com.example.prayertimemanager.PrayerTimeManager.PrayerTimeManager
    private var nextPrayerTime = mutableStateOf(
        com.example.prayertimemanager.PrayerTimeManager.PrayerTime(
            0,
            "",
            "",
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        prayerTimeManager =
            com.example.prayertimemanager.PrayerTimeManager.PrayerTimeManager(applicationContext)
